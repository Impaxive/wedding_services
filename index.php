<?php include('dbconn.php') ?>
                        ...
                        <div class="carousel-item">
                            <a href="http://ec2-13-234-29-49.ap-south-1.compute.amazonaws.com/<?php echo $_SESSION['locationUrl']?>/<?php echo $category_url; ?>" class="listing-item-container">
                                <div class="listing-item">
                                    <img src="https://mywedservices.s3.ap-south-1.amazonaws.com/<?php echo $thumbnail_img_c;  ?>" alt="">
    ...
    <?php
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $category_url = $row['url'];
            $featured_image = $row['featured_image'];
            $thumbnail_img_venue = $row['thumbnail_img'];
            $catid = $row['category_id'];
            $desc = $row['description'];
        }
    }   
    ...
    <section class="fullwidth border-top margin-top-40 padding-top-40"
        ...
        <?php
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                $category_u = $row['url'];
                $featured_image = $row['featured_image'];
                $thumbnail_img_deco = $row['thumbnail_img'];
                $catid = $row['category_id'];
                $desc = $row['description'];
            }
        }   
        ...
        <div class="container">
            ...
            <?php
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    $category_u = $row['url'];
                    $featured_image = $row['featured_image'];
                    $thumbnail_img_cateres = $row['thumbnail_img'];
                    $catid = $row['category_id'];
                    $desc = $row['description'];
                }
            }   
        ...
        <div class="container">
            ...
            <?php
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    $category_u = $row['url'];
                    $featured_image = $row['featured_image'];
                    $thumbnail_img_photo = $row['thumbnail_img'];
                    $catid = $row['category_id'];
                    $desc = $row['description'];
                }
            }   
        ...
        <div class="container">
            ...
            <?php
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    $category_u = $row['url'];
                    $featured_image = $row['featured_image'];
                    $thumbnail_img_makeup = $row['thumbnail_img'];
                    $catid = $row['category_id'];
                    $desc = $row['description'];
                }
            }   
