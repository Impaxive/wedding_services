                ...
                <?php 
                    if (isset($_POST['submit'])){
                        ...
                        if(empty($errors)==true){
                            $sql = "INSERT INTO posts(title,url,tags,featured_image,post_content,thumbnail_img,created_date)
                                    VALUES('$title','$url','$meta_tags','$image_names','$post_content','$thumbnail_img','$created_date')";
