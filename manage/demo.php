                        ...
                        for($i=0;$i<$imageCount;$i++){
                         ...
                         if(empty($errors)==true){
                          ...
                          if($res_v->num_rows >0){
                            ...
                            $sql = "INSERT INTO listing_table(correl_id,title,url,meta_tags,featured_image,category_id,location_id,pricing,about,price_range,position,vendor_name,vendor_plan_type,vendor_mobile_number,live_booking,whatsapp_chat,created_date)
                                    VALUES('$correl_id','$title','$url','$meta_tags','$image_names','$cat_id','$l_id','$pricing','$about','$price_range','position','$vendor_name','$vendor_planType','$m_number','$live_booking','$whatsapp_chat','$created_date')";
